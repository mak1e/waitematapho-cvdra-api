...
ActiveRecord::Schema.define(:version => 170) do
  ...
  create_table "claims_data", :force => true do |t|
    ...
    t.string   "refto_Referral_To",                                 :limit => 28
    ...
    t.string   "slty_skin_lesion_type",                             :limit => 35
    ...
    t.string   "refft_referral_from_type",                          :limit => 28
    ...
    t.boolean  "hayf_hay_fever"
    t.boolean  "hypv_hyperventilation"
    t.boolean  "gord_gastro_oesophageal_reflux"
    t.boolean  "rhin_rhinitis"
    t.boolean  "ecze_eczema"
    t.string   "infvac_influenza_vacc_given",                       :limit => 8
    t.boolean  "trgemo_trigger_emotions"
    t.boolean  "trgani_trigger_animals"
    t.boolean  "trgexe_trigger_exercise"
    t.boolean  "trgfdr_trigger_food_drink"
    t.boolean  "trgres_trigger_respiratory_infection"
    t.boolean  "trgasp_trigger_aspirin"
    t.boolean  "trgocc_trigger_occupational"
    t.boolean  "trghor_trigger_hormonal"
    t.boolean  "trgcai_trigger_cold_air"
    t.boolean  "trgdus_trigger_dust"
    t.string   "icsuse_ics_usage",                                  :limit => 8
    t.string   "slbt_skin_lesion_benign_type",                      :limit => 35
    t.string   "rfiskc_foot_risk_category",                         :limit => 26
    t.string   "podref_podiatary_referral",                         :limit => 26
    t.string   "podref_podiatary_referral2",                        :limit => 26
    t.string   "ohyp_other_hypoglycaemic_medication",               :limit => 18
    t.string   "podr_podiatry_referral_today",                      :limit => 18
    t.string   "alus_alcohol_under_surveillance",                   :limit => 8
    t.string   "alfq_alcohol_frequency",                            :limit => 24
    t.integer  "alds_alcohol_drinks_per_session"
    t.string   "albf_alcohol_binge_frequency",                      :limit => 18
    t.integer  "dcsa_drink_check_section_a"
    t.integer  "dcsb_drink_check_section_b"
    t.integer  "dcsc_drink_check_section_c"
    t.string   "alrc_alcohol_readiness_to_change",                  :limit => 18
    t.string   "alag_alcohol_advice_given",                         :limit => 8
    t.integer  "noga_number_of_group_attendances"
    t.integer  "nopga_number_of_partner_group_attendances"
    t.string   "pnrt_pnap_referral_to",                             :limit => 48
    t.string   "pnrt2_pnap_referral_to_2",                          :limit => 48
    t.integer  "epdssc_epds_score"
    t.integer  "epds10_epds_self_harm"
    t.integer  "mhgad7_mhealth_gad_7"
    t.string   "etcon_e_therapy_condition",                         :limit => 18
    t.string   "mhth_mh_therapy",                                   :limit => 18
    t.string   "pedsqv_peds_question_values",                       :limit => 20
    t.string   "sdqqv_sdq_question_values",                         :limit => 50
    t.string   "prio_priority_level",                               :limit => 30
    t.string   "cont_contact_type",                                 :limit => 32
    t.string   "conl_contact_location",                             :limit => 28
    t.string   "demen_dementia",                                    :limit => 18
    t.datetime "ds01_date_service_01"
    t.datetime "ds02_date_service_02"
    t.datetime "ds03_date_service_03"
    t.datetime "ds04_date_service_04"
    t.datetime "ds05_date_service_05"
    t.datetime "ds06_date_service_06"
    t.datetime "ds07_date_service_07"
    t.datetime "ds08_date_service_08"
    t.datetime "ds09_date_service_09"
    t.datetime "ds10_date_service_10"
    t.datetime "ds11_date_service_11"
    t.boolean  "trgmold_trigger_mould_damp"
    t.boolean  "fhato_fh_atopy"
    t.boolean  "sinu_sinusitis"
    t.string   "refts_referral_to_status",                          :limit => 18
    t.string   "abass_abuse_assessment",                            :limit => 32
    t.string   "abinc_abuse_screen_incomplete",                     :limit => 32
    t.string   "abmen_abuse_mental",                                :limit => 28
    t.string   "abphy_abuse_physical",                              :limit => 28
    t.string   "absex_abuse_sexual",                                :limit => 28
    t.string   "abneg_abuse_neglect",                               :limit => 28
    t.string   "acc_acc_accident",                                  :limit => 18
    t.string   "advg_advice_info_given",                            :limit => 28
    t.string   "maosu_maori_support",                               :limit => 28
    t.string   "abvho_abuse_present_at_home",                       :limit => 18
    t.string   "abunc_abuse_uncorroborated_history",                :limit => 18
    t.string   "abcyf_abuse_ho_cyfs_engagement",                    :limit => 18
    t.string   "abdel_abuse_delay_medical_advice",                  :limit => 18
    t.string   "abtra_abuse_history_trauma",                        :limit => 18
    t.string   "abvhi_abuse_changing_history",                      :limit => 18
    t.string   "abcdr_abuse_changing_dr",                           :limit => 18
    t.string   "abgus_abuse_gastrourinary_sx",                      :limit => 18
    t.string   "provt_provider_type",                               :limit => 18
    t.integer  "km_kilometeres"
    t.string   "ihd_heart_disease",                                 :limit => 18
    t.string   "resp_respiratory_illnesses",                        :limit => 18
    t.string   "nurref_nutritionist_referral",                      :limit => 18
    t.string   "reas_reason",                                       :limit => 18
    t.string   "treat_treatment",                                   :limit => 18
    t.string   "vono_voucher_no",                                   :limit => 18
    t.string   "alcs_alcohol_consumption",                          :limit => 18
    t.string   "alar_alcohol_at_risk",                              :limit => 18
    t.boolean  "mhswk_mhealth_contract_social_worker"
    t.datetime "accd_acc_accident_date"
    t.boolean  "amgmt_under_active_mgmt"
    t.boolean  "cpo_hardship"
    t.string   "cpo_number",                                        :limit => 50
    t.string   "sl1_site",                                          :limit => 50
    t.string   "sl1_side",                                          :limit => 50
    t.string   "sl1_procedure",                                     :limit => 50
    t.string   "sl1_outcome",                                       :limit => 50
    t.string   "sl2_site",                                          :limit => 50
    t.string   "sl2_side",                                          :limit => 50
    t.string   "sl2_procedure",                                     :limit => 50
    t.string   "sl2_outcome",                                       :limit => 50
    t.string   "qwe_me_test",                                       :limit => 50
    t.string   "typeOfConsultation",                                :limit => 48
    t.string   "providerType",                                      :limit => 48
    t.string   "methodOfConsultation",                              :limit => 48
    t.string   "reasonForConsultationA",                            :limit => 48
    t.string   "reasonForConsultationS",                            :limit => 48
    t.string   "reasonForConsultationC",                            :limit => 48
    t.string   "reasonForConsultationO",                            :limit => 48
    t.string   "referral",                                          :limit => 48
    t.boolean  "confirmClaim"
    t.string   "testPositive",                                      :limit => 48
    t.string   "contactTracingCompleted",                           :limit => 48
    t.string   "partnerManagementDiscussed",                        :limit => 48
    t.string   "patientCompliantWithTreatment",                     :limit => 48
    t.string   "didPatientAdvisePartner",                           :limit => 48
    t.string   "contraceptionPrescribedC",                          :limit => 30
    t.string   "contraceptionPrescribedE",                          :limit => 30
    t.string   "contraceptionPrescribedO",                          :limit => 30
    t.string   "contraceptionPrescribedI",                          :limit => 30
    t.string   "contraceptionPrescribedJ",                          :limit => 30
    t.string   "contraceptionPrescribedR",                          :limit => 30
    t.string   "contraceptionPrescribedD",                          :limit => 30
    t.string   "contraceptionPrescribedM",                          :limit => 30
    t.string   "previousSTI",                                       :limit => 48
    t.string   "diagnosticTestingB",                                :limit => 30
    t.string   "diagnosticTestingS",                                :limit => 30
    t.string   "diagnosticTestingG",                                :limit => 30
    t.string   "diagnosticTestingD",                                :limit => 30
    t.string   "diagnosticTestingN",                                :limit => 30
    t.string   "site_diag01",                                       :limit => 48
    t.string   "site_diag02",                                       :limit => 48
    t.string   "site_diag03",                                       :limit => 48
    t.string   "site_diag04",                                       :limit => 48
    t.string   "site_diag05",                                       :limit => 48
    t.string   "site_diag06",                                       :limit => 48
    t.string   "site_diag07",                                       :limit => 48
    t.string   "site_diag08",                                       :limit => 48
    t.string   "site_diag09",                                       :limit => 48
    t.string   "occur_diag01",                                      :limit => 48
    t.string   "occur_diag02",                                      :limit => 48
    t.string   "occur_diag03",                                      :limit => 48
    t.string   "occur_diag04",                                      :limit => 48
    t.string   "occur_diag05",                                      :limit => 48
    t.string   "occur_diag06",                                      :limit => 48
    t.string   "occur_diag07",                                      :limit => 48
    t.string   "occur_diag08",                                      :limit => 48
    t.string   "occur_diag09",                                      :limit => 48
    t.boolean  "cbProv_diag01Y"
    t.boolean  "cbProv_diag02Y"
    t.boolean  "cbProv_diag03Y"
    t.boolean  "cbProv_diag04Y"
    t.boolean  "cbProv_diag05Y"
    t.boolean  "cbProv_diag06Y"
    t.boolean  "cbProv_diag07Y"
    t.boolean  "cbProv_diag08Y"
    t.boolean  "cbProv_diag09Y"
    t.boolean  "cbConf_diag01Y"
    t.boolean  "cbConf_diag02Y"
    t.boolean  "cbConf_diag03Y"
    t.boolean  "cbConf_diag04Y"
    t.boolean  "cbConf_diag05Y"
    t.boolean  "cbConf_diag06Y"
    t.boolean  "cbConf_diag07Y"
    t.boolean  "cbConf_diag08Y"
    t.boolean  "cbConf_diag09Y"
  end
  ...
  create_table "ethnicities", :force => true do |t|
    ...
    t.string   "ethnicity_level1",    :limit => 18
    t.integer  "order_by_level1"
    t.string   "ethnicity_mpi",       :limit => 18
    t.integer  "order_by_mpi"
  end
  ...
  create_table "fee_schedules", :force => true do |t|
    ...
    t.string   "gl_account_no",          :limit => 18
  ...
  create_table "organisations", :force => true do |t|
    ...
    t.decimal  "cbf_cplus_perage",                       :precision => 5, :scale => 2
    t.decimal  "cbf_under6_perage",                      :precision => 5, :scale => 2
    t.integer  "cbf_under6_qtrly_payment"
    t.decimal  "cbf_vcla_perage",                        :precision => 5, :scale => 2
    t.integer  "cbf_vcla_qtrly_payment"
    t.decimal  "cbf_hp_perage",                          :precision => 5, :scale => 2
    t.decimal  "cbf_sia_perage",                         :precision => 5, :scale => 2
    t.string   "supplier_code",            :limit => 14
    t.string   "gl_cost_centre",           :limit => 18
    t.string   "cbf_supplier_code",        :limit => 14
    t.string   "cbf_ident_alt",            :limit => 16
  end
  ...
  create_table "programme_elements", :force => true do |t|
    ...
    t.string  "report_by",             :limit => 36
    t.boolean "report_by_transpose"
    t.string  "report_by_2",           :limit => 36
    t.boolean "report_by_transpose_2"
  end
  ...
  create_table "programmes", :force => true do |t|
    ...
    t.boolean  "incl_zero_advice",                                                        :default => false, :null => false
    t.integer  "claim_limit_count"
    t.integer  "claim_limit_period_mths"
    t.integer  "claim_limit_claim_status_id"
    t.string   "claim_limit_claim_comment",   :limit => 18
    t.integer  "same_day_claim_status_id"
    t.string   "same_day_claim_comment",      :limit => 18
  end
  ...
  create_table "settings", :force => true do |t|
    ...
    t.string   "cbf_cap_gl_account_no",    :limit => 18
    t.string   "cbf_ded_gl_account_no",    :limit => 18
    t.string   "cbf_cplus_gl_account_no",  :limit => 18
    t.string   "cbf_under6_gl_account_no", :limit => 18
    t.string   "cbf_vcla_gl_account_no",   :limit => 18
    t.string   "cbf_hp_gl_account_no",     :limit => 18
    t.string   "cbf_sia_gl_account_no",    :limit => 18
  end
