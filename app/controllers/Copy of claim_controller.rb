...
#
    ...
    def lodge
       begin
         ...
         raise ArgumentError, "Programme Not Found" if programme.blank?
         ...
         if ( claim_p[:update] == 'elems' )
           ...
           raise ArgumentError, "Fee Schedule Not Found/No Default" if fee_schedule.blank?
           ...
           if ( claim.blank? )
             ...
             if ( patient.nhi_no =~ /^(ABC1235|ABC1345|ABC1346|AAA9999|ABC0000|AAA0000)$/ )
           ...
           unless claim.claim_status_id == ClaimStatus::DELETED
             ...
             if claim.amount.to_f > 0  # Zero value claims are OK.  
